...
OUTPUT_DIR_PATH="/home/kumada/data/gemini_workspace/"
IMAGE_SUB_DIR_PATH="Axle_shaft"
FILE_NAME="Axle_shaft"
...
uv run python -m src.invoke_gemini \
    ...
    --output_path "${OUTPUT_DIR_PATH}/${FILE_NAME}.txt" \
    --max_tokens ${MAX_TOKENS} \
    --top_p ${TOP_P} \
    --temperature ${TEMPERATURE}

#_/_/_/ 動画一本をGeminiに投げる。
#ROOT_DIR_PATH="/home/kumada/data/3d_model_analyzer_with_movie/"
#IMAGE_SUB_DIR_PATH="dragon_2.5"
#FILE_NAME="dragon_2.5"
##OUTPUT_SUB_DIR_PATH="gemini_outputs"
#OUTPUT_DIR_PATH="/home/kumada/data/gemini_workspace/"
#MAX_TOKENS=8192
#TOP_P=1.0
...
#    --output_path "${OUTPUT_DIR_PATH}/${FILE_NAME}_with_movie.txt" \
#    --max_tokens ${MAX_TOKENS} \
#    --top_p ${TOP_P} \
#    --temperature ${TEMPERATURE}
